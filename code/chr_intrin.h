...
inline float
FloatMod(float32 Num, float32 By)
{
    float32 Result = (float32)fmod(Num, By);
    return Result;
}
...
Sign(float32 X)
{
    float32 Result = (float32)copysign(1, X);
    return Result;
}

inline float32
FractionalPart(float32 X)
{
    double IntegerPartIgnored;
    float32 Result = (float32)modf(X, &IntegerPartIgnored);
    return Result;
}

inline float32
Pow(float32 X, float32 P)
{
    float32 Result = (float32)powf(X, P);
    return Result;
}
...
LogE(float32 X)
{
    float32 Result = (float32)logf(X);
    return Result;
}
inline float32
LogN(float32 X, float32 N)
{
    float32 Result = (float32)logf(X) / (float32)logf(N);
    return Result;
}
...
Log10(float32 X)
{
    float32 Result = (float32)log10(X);
    return Result;
}
